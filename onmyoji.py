...
# Form implementation generated from reading ui file 'onmyoji.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.mitama_driver, 2, 0, 1, 1)
        ...
        self.mitama_three = QtWidgets.QRadioButton(self.groupBox)
        self.mitama_three.setObjectName("mitama_three")
        self.gridLayout.addWidget(self.mitama_three, 4, 0, 1, 1)
        ...
        self.explore_passenger = QtWidgets.QRadioButton(self.tab_2)
        self.explore_passenger.setObjectName("explore_passenger")
        self.gridLayout_5.addWidget(self.explore_passenger, 2, 0, 1, 1)
        self.horizontalSlider = QtWidgets.QSlider(self.tab_2)
        self.horizontalSlider.setSliderPosition(10)
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.gridLayout_5.addWidget(self.horizontalSlider, 7, 0, 1, 1)
        self.explore_single = QtWidgets.QRadioButton(self.tab_2)
        self.explore_single.setChecked(True)
        self.explore_single.setObjectName("explore_single")
        self.gridLayout_5.addWidget(self.explore_single, 0, 0, 1, 1)
        self.explore_driver = QtWidgets.QRadioButton(self.tab_2)
        self.explore_driver.setObjectName("explore_driver")
        self.gridLayout_5.addWidget(self.explore_driver, 1, 0, 1, 1)
        self.explore_dual = QtWidgets.QRadioButton(self.tab_2)
        self.explore_dual.setObjectName("explore_dual")
        self.gridLayout_5.addWidget(self.explore_dual, 3, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.checkBox_3, 6, 0, 1, 1)
        ...
        self.autoMark = QtWidgets.QCheckBox(self.groupBox_2)
        self.autoMark.setChecked(True)
        self.autoMark.setObjectName("autoMark")
        self.gridLayout_7.addWidget(self.autoMark, 0, 0, 1, 1)
        ...
        self.ShiShenPosY = QtWidgets.QLineEdit(self.groupBox_2)
        self.ShiShenPosY.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.ShiShenPosY.setObjectName("ShiShenPosY")
        self.gridLayout_7.addWidget(self.ShiShenPosY, 2, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.lineEdit_2, 6, 1, 1, 1)
        self.ShiShenPosX = QtWidgets.QLineEdit(self.groupBox_2)
        self.ShiShenPosX.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.ShiShenPosX.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.ShiShenPosX.setObjectName("ShiShenPosX")
        self.gridLayout_7.addWidget(self.ShiShenPosX, 1, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(self.groupBox_2)
        self.label_3.setObjectName("label_3")
        self.gridLayout_7.addWidget(self.label_3, 6, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mitama_three.setText(_translate("MainWindow", "三开"))
        ...
        self.explore_passenger.setText(_translate("MainWindow", "打手"))
        self.explore_single.setText(_translate("MainWindow", "单刷"))
        self.explore_driver.setText(_translate("MainWindow", "司机"))
...
"最好把“合并相同式神”选项关闭。"))
        ...
        self.autoMark.setText(_translate("MainWindow", "御魂自动标记式神"))
        self.lineEdit.setText(_translate("MainWindow", "100"))
        self.label_6.setText(_translate("MainWindow", "  标记式神所处坐标(X,Y)："))
        self.ShiShenPosY.setText(_translate("MainWindow", "388"))
        self.lineEdit_2.setText(_translate("MainWindow", "20"))
        self.ShiShenPosX.setText(_translate("MainWindow", "540"))
